  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        ...
        <span className="text-white font-semibold tracking-wide text-lg ml-2">ABES</span>
      </div>

      {/* Desktop Navigation */}
      <div className="hidden md:flex items-center space-x-8 mr-auto ml-16">
        <a href="#" className="text-white hover:text-orange-400 transition" style={{ color: 'white' }}>Challenges</a>
        <a href="#" className="text-white hover:text-orange-400 transition" style={{ color: 'white' }}>Services</a>
        <a href="#" className="text-white hover:text-orange-400 transition" style={{ color: 'white' }}>About us</a>
        <a href="#" className="text-white hover:text-orange-400 transition" style={{ color: 'white' }}>Success stories</a>
      </div>
